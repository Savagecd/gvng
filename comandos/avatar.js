    ...
    message.delete() //Si quieres lo dejas así o se lo quitas
     let user = message.mentions.users.first() || message.author
      ...
      //Si no se menciona a alguien mandará tu avatar
            ...
            .setColor(0x66b3ff)
            .setFooter(`Avatar de ${message.author.username}#${message.author.discriminator}`,client.user.avatarURL);
      ...
      //Podeis cambiar el embed a tu gusto en (color - footer)
            ...
            .setColor(0x66b3ff)
            .setFooter(`Avatar de ${img.username}#${img.discriminator}, Pedido por ${message.author.username}`,client.user.avatarURL );
            message.channel.send({ embed });
